...
PURPOSE: 		Food Security & Livelihood Dataset Data Analysis, by geo location
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/01_sumstat_fsl_geo_hh_campvill.xls",  sheet("hhmem_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/02_sumstat_fsl_fcs_campvill.xls",  sheet("fcs_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/02_sumstat_fsl_fcs_campvill.xls",  sheet("fcs1_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/03_sumstat_fsl_hhds_campvill.xls",  sheet("hhds_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/04_sumstat_fsl_market_hfias_campvill.xls",  sheet("merket_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/04_sumstat_fsl_market_hfias_campvill.xls",  sheet("hfias_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/05_sumstat_fsl_job_income_campvill.xls",  sheet("job_income_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/06_sumstat_fsl_lcsi_migt_campvill.xls",  sheet("lcsi_migt_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/07_sumstat_fsl_hhassets_campvill.xls",  sheet("hhassets_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/08_sumstat_fsl_hhexpense_campvill.xls",  sheet("hhexpense_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/08_sumstat_fsl_hhexpense_campvill.xls",  sheet("share_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/09_sumstat_fsl_creditsave_campvill.xls",  sheet("loan_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/09_sumstat_fsl_creditsave_campvill.xls",  sheet("save_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/09_sumstat_fsl_creditsave_campvill.xls",  sheet("flitracy_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/10_sumstat_fsl_jobobst_campvill.xls",  sheet("boysvy_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/10_sumstat_fsl_jobobst_campvill.xls",  sheet("girlsvy_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/10_sumstat_fsl_jobobst_campvill.xls",  sheet("mensvy_`y'_`x'") firstrow(varlabels) sheetreplace 
	...
	forvalue x = 0/1 {
		...
		if _N > 0 {
			...
			if _N > 0 {
				...
				export excel $export_table using "$out/_fsl_hh/10_sumstat_fsl_jobobst_campvill.xls",  sheet("womensvy_`y'_`x'") firstrow(varlabels) sheetreplace 
